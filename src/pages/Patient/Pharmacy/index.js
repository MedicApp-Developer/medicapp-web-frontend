                    ...
                    <div class="col-md-12">
                        <form>
                            <div class="form-group position-relative d-sm-flex">
                                ...
                                <input type="text" class="form-control mr-3 mb-3" placeholder="Enter pharmacy" />
                ...
                <div class="container">
                    ...
                    <div class="col-md-7">
                        <div class="d-flex justify-content-between align-items-center mb-4 mt-4 mt-md-0">
                            <h5 class="text-primary mb-0">1000 Pharmacy</h5>
                        ...
                        <div class="media mb-3">
                            ...
                            <div class="media-body">
                                ...
                                <h5 class="mt-0">Aster Pharmacy</h5>
                                <span>
                    ...
                    <div class="col-md-2 mt-4 mt-md-0">
                        <a href="javascript:void(0)" class="btn btn-primary px-3 mb-3">Pharmacy 
                        Registration</a>
