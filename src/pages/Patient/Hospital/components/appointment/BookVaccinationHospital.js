...
function BookVaccinationHospital({ hospital }) {
    ...
    useEffect(() => {
        SlotApi.getHospitalPCRVaccinationSlots(id).then(res => {
    ...
    return (
        <>
            ...
            <div className="modal fade" id="hospitalVaccinationBookAppointment" tabindex="-1" aria-labelledby="hospitalVaccinationBookAppointmentLabel" aria-hidden="true">
