...
function GalleryImgePicker({ image, updatePicture, removePicture, DEFAULTIMAGE }) {
	...
	return (
		<div >
			<div class="col-md-1 text-right" style={{ visibility: 'hidden' }}>
				<a ref={imageCropRef} href={href} data-toggle="modal" data-target="#galleryImageCropp" class="btn btn-primary px-3"></a>
			</div>
			<div >
				<ImageUploading
					value={images}
				...
				>
					{({
						...
						<>
							<div className="text-center" style={{ width: '300px', height: '300px', borderRadius: '10px', cursor: "pointer" }}>
								<div style={{
								...
								</div>
								{
									<img
										...
										alt="doctor"
										style={{ width: '300px', height: '300px', borderRadius: '10px', objectFit: 'cover', }} //border: '1px solid #D3D3D3'
										{...dragProps}
									/>
								}
							</div>
				...
				<GalleryImageCrop selectedFile={images[0]} croppedImageFile={croppedImageHandler} />
			</div>
		</div>
	)
}
